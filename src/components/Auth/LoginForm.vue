...
import { user_email, user_password, switchAuthView } from '@/services/authServices'
...
<template>
    <div class="min-h-screen w-full flex items-center justify-center p-4 background-auth text-white/80">
            ...
            <div class="min-h-90 w-full flex flex-col items-center space-y-10 rounded-3xl md:p-5 p-3">
                ...
                <div class="flex flex-col justify-center w-full space-y-8">
                    <div class="flex flex-col space-y-3">
                        ...
                        <input type="email" v-model="user_email" placeholder="enter your email..."
                            class="w-full outline-gray-500 py-3 px-5 rounded-3xl outline" />
                    </div>
                    <div class="flex flex-col space-y-3">
                        <label for="user_password" class="px-4">Password</label>
                        <input type="password" v-model="user_password" placeholder="enter your password..."
                            class="w-full outline-gray-500 py-3 px-5 rounded-3xl outline" />
                    </div>
                    <button @click="handleSignIn()" v-if="loading == false"

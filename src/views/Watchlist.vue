...
<template>
  <div class="min- h-screen w-full bg-[#2e2e2e] text-center text-gray-200">
    <!-- <Nav /> -->
    ...
    <div class="h-full w-full p-6" v-else>
      <div class="h-full w-full md:mt-20 mt-14">
        ...
        <div class="flex justify-center md:p-3">
          ...
          >
            <div
              ...
              :key="index"
              class="flex flex-col justify-evenly text-xs md:text-base shadow-xl md:p-3 transition-transform duration-500 ease-in-out transform md:hover:scale-105"
            >
              <img
